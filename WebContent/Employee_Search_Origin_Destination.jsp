...
<body>
    ...
    String Origin_Station = request.getParameter("origin");
    String Destination_Station = request.getParameter("destination");
    ...
    rs = st.executeQuery("SELECT " +
    	...
    	"FROM route rt " +
    	 ...
    	 "left join train trn on trn.route_id = rt.id " +
    		"WHERE " +
    			"stn_orgn.name = '" + Origin_Station + "' " +
    	        "AND " +
    	        "stn_dest.name = '" + Destination_Station + "' " +
