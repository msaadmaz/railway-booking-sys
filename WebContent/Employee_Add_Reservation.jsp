...
<html>
  <head>
    <title>Employee Add Reservation</title>
  ...
  <body>
    ...
    <h2>Add Reservation for one of these</h2>
    ...
    <table>
      ...
      <%  while (rs.next()) { %>
            <tr>
              ...
              <td><a href="Employee_Add_Reservation_fill_out.jsp?tripId=<%= rs.getInt("id") %>">Click here to book</a></td>
            </tr>
      <%  } %>
    </table>
